    ...
    return <div className="bioContainer">
        ...
        <div>
            ...
            <ul>
                ...
                <li>Developing an internationally recognized quality improvement program for law firms, which was chronicled in the book <i>TQM in Action: One Firm's Journey toward Quality and Excellence, Published by the American Bar Association.</i></li>
